                  ...
                  <div className=" chartCardMiddle" style={{ padding: "24px" }}>
                    ...
                    >
                      ...
                      <div className="divStory">
                        ...
                        <Divider />
                        <div className="marginList1">
                          <Label className="marginList">Amount :</Label>
                        </div>
                        <Divider />
                        <div className="marginList1">
                          <Label className="marginList">Fees :</Label>
                        </div>
                        <Divider />
                        <div className="marginList1">
                          <Label className="marginList">Date :</Label>
                        </div>
                        <Divider />
                        <div className="marginList1">
                          <Label className="marginList">Time :</Label>
                        </div>
                        <Divider />
                        <div className="marginList1">
                        ...
                        <Divider />
                        <div className="marginList1">
                          <Label className="marginList">Reason :</Label>
                        </div>
                        <Divider />
                        <div className="marginList1">
                          <Label className="marginList">Currency :</Label>
                        </div>
                        <Divider />
