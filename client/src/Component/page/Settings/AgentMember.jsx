...
class AgentMember extends Component {
  ...
  submitData = () => {
    ...
    this.props.registerAgentMember(
      sessionStorage.getItem("token"),
      formData,
      this.props.history,
      phoneNumberSplit.join(""),
      phoneNumberSplit[0].replace("+", "")
    );
    this.setState({
      viewModal: false,
  ...
  componentWillReceiveProps = async (nextprops) => {
    ...
    if (nextprops.getAllAgentMemberList) {
      let filteredAgentMembersList = nextprops.getAllAgentMemberList.filter(
        (data) => {
    ...
    if (nextprops.packagesStatus && nextprops.packagesDetails) {
      if (nextprops.packagesDetails._embedded) {
        this.setState(
          {
            agentPackagesData:
              nextprops.packagesDetails._embedded.agentPackageDtoList,
          },
          () => {
                        ...
                        >
                          <div className="containerBiaN_form">
                            ...
                            <div className="containerBiaN_f_row">
                              <div className="containerBiaN_f_col width30percent textAlignRight">
                                <label>
                                  <FormattedMessage id="agent.UploadPhotoorSelfie" />
                                </label>
                              </div>
                              <div className="containerBiaN_f_col width70percent">
                                <Upload
                                  ...
                                  onChange={(file) =>
                                    this.handleChangeUpload(file, "selfie")
                                  }
                                >
                                  {imageUrl ? (
                                    <img
                              ...
                              <div className="containerBiaN_f_col width70percent">
                                <div className="categorySelect">
                                  <Select
                                    ...
                                    style={{ width: 100 + "%", height: 52 }}
                                    onChange={(e) =>
                                      this.handleChangeSelect(e, "gender")
                                    }
                                    id={"page-size"}
                                  >
                                    <Option value="">
                                      <FormattedMessage id="agent.SelectGender" />
                                    </Option>
                                    <Option value="Male">
                                      <FormattedMessage id="agent.Male" />
                                    </Option>
                                    <Option value="Female">
                                      <FormattedMessage id="agent.Female" />
                                    </Option>
                                  </Select>
                                </div>
                              </div>
                            ...
                            <div className="containerBiaN_f_row">
                              <div className="containerBiaN_f_col width30percent textAlignRight">
                                <label>
                                  <FormattedMessage id="agent.BusinessType" />
                                </label>
                              </div>
                              <div className="containerBiaN_f_col width70percent">
                                <div className="categorySelect">
                                  <Select
                                    ...
                                    style={{ width: 100 + "%", height: 52 }}
                                    onChange={(e) =>
                                      this.handleChangeSelect(e, "businessType")
                                    }
                                    id={"page-size"}
                                  >
                                    <Option value="">
                                      <FormattedMessage id="agent.SelectBusinessType" />
                                    </Option>
                            ...
                            <div className="containerBiaN_f_row">
                              <div className="containerBiaN_f_col width30percent textAlignRight">
                                <label>
                                  <FormattedMessage id="agent.IDName" />
                                </label>
                              </div>
                              <div className="containerBiaN_f_col width70percent">
                            ...
                            <div className="containerBiaN_f_row">
                              <div className="containerBiaN_f_col width30percent textAlignRight">
                                <label>
                                  <FormattedMessage id="agent.UploadIDImage(frontandback)" />
                                </label>
                              </div>
                              <div className="containerBiaN_f_col width70percent">
                                <Upload
                                  ...
                                  customRequest={dummyRequest}
                                  onChange={(file) =>
                                    this.handleChangeUpload(file, "idphoto")
                                  }
                                >
                                  {imageUrl ? (
                                    <img
                            ...
                            <div className="containerBiaN_f_row">
                              <div className="containerBiaN_f_col width30percent textAlignRight">
                                <label>
                                  <FormattedMessage id="agent.Idexpireddate" />
                                </label>
                              </div>
                              <div className="containerBiaN_f_col width70percent">
                                <DatePicker
                            ...
                            <div className="containerBiaN_f_row">
                              <div className="containerBiaN_f_col width30percent textAlignRight">
                                <label>
                                  <FormattedMessage id="agent.UniqueIdentificationNumber" />
                                </label>
                              </div>
                              <div className="containerBiaN_f_col width70percent">
                                <input
                            ...
                            <div className="containerBiaN_f_row">
                              <div className="containerBiaN_f_col width30percent textAlignRight">
                                <label>
                                  <FormattedMessage id="agent.PackageType" />
                                </label>
                              </div>
                              <div className="containerBiaN_f_col width70percent">
                                <div className="categorySelect">
                                  ...
                                  >
                                    ...
                                    {this.state.agentPackagesData &&
                                      this.state.agentPackagesData.map(
                                        (data) => {
                                          if (
                                            data.agentType === "AGENT_MEMBER"
                                          ) {
                                            return (
                                              <>
                            ...
                            <div className="containerBiaN_f_row">
                              <div className="containerBiaN_f_col width30percent textAlignRight">
                                <label>
                                  <FormattedMessage id="agent.RegistrationAppliedPlace" />
                                </label>
                              </div>
                              <div className="containerBiaN_f_col width70percent">
                                <input
                                  type="text"
                                  placeholder="Enter registartion place"
                                  name="place"
                                  onChange={this.handleChangeInput}
                                />
                              </div>
                            ...
                            <div className="containerBiaN_f_row">
                              <div className="containerBiaN_f_col width30percent textAlignRight">
                                <label>
                                  <FormattedMessage id="agent.BusinessName(Optional)" />
                                </label>
                              </div>
                              <div className="containerBiaN_f_col width70percent">
                                <input
                          ...
                          <div style={{ width: "100%", float: "left" }}>
                            <div className="custom-d-flex confirm_p_w mTB00 button-container rspacing">
                              ...
                              <button
                                ...
                                onClick={this.Review}
                              >
                                <FormattedMessage id="agent.Review" />
                              </button>
                            </div>
                          </div>
                        </div>
                  ...
                  <table className="table table-responsive table-borderless">
                    <tbody>
                      ...
                      <tr>
                        <td>Package Set</td>
                        <td>
                          {this.state.agentPackagesData.map((data) => {
                      ...
                      <tr>
                        ...
                        <td>
                          {this.state.selfie &&
                            this.state.selfie.thumbUrl !== "" && (
                              <img
                                style={{ height: "80px", width: "80px" }}
                                src={this.state.selfie.thumbUrl}
                              />
                            )}
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          {this.state.addressProof &&
                            this.state.addressProof.thumbUrl !== "" && (
                              <img
                                style={{ height: "80px", width: "80px" }}
                                src={this.state.addressProof.thumbUrl}
                              />
                            )}
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          {this.state.idphoto &&
                            this.state.idphoto.thumbUrl !== "" && (
                              <img
                                style={{ height: "80px", width: "80px" }}
                                src={this.state.idphoto.thumbUrl}
                              />
                            )}
                        </td>
                      </tr>
...
const mapStateToProps = ({ agentReducer, commonReducer }) => {
  const { getAllAgentMemberList, packagesDetails, packagesStatus } =
    agentReducer;
...
const mapDispatchToProps = (dispatch) => {
  return {
    registerAgentMember: (token, data, history, phoneNumber, mobialCode) =>
      dispatch(
        registerAgentMember(token, data, history, phoneNumber, mobialCode)
      ),
