...
import {
  doesBankAccountExist,
  getBankAccountCustomerAndSendOTP,
  verifyBankCustomerOTP,
...
class AddAccount extends Component {
  ...
  componentDidMount = () => {
    ...
    if (this.props.profileDetails)
      this.props.fetchAgentBankAccounts(
        ...
        this.props.profileDetails.bankCustomerId
      );
  };
  ...
  componentWillReceiveProps = (nextprops) => {
    ...
    if (
      nextprops.bankAccountDetailsFetchSuccessful &&
      nextprops.bankAccountData.accNo !== undefined
    ) {
      this.setState({
                        ...
                        <div className="accountTable_wrap">
                          <table className="accountTable">
                            ...
                            <tbody>
                              ...
                              {this.state.agentBankAccountsList &&
                                this.state.agentBankAccountsList.length > 0 &&
                                this.state.agentBankAccountsList.map(
                                  (item, index) => (
                                    <tr>
                                      <td>
                                        <input
                                      ...
                                      <td style={{ display: "flex" }}>
                                        <button className="btn  btn-sm btn-danger pull-left">
                                          Remove
                                        </button>
                                        {/* {
          ...
          {this.state.accountDetailsModalShow &&
            this.state.bankCustomerData && (
              <Modal
                ...
                onCancel={() =>
                  this.setState({ accountDetailsModalShow: false })
                }
                style={{ minWidth: "25%" }}
                footer={null}
              >
                        ...
                        <table style={{ width: "100%" }}>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td align="right">
                                {this.state.currentAccountDetails.accNo}
                              </td>
                            </tr>
                            <tr>
                              <td width="25%" style={{ fontWeight: "bold" }}>
                              ...
                              <td align="right">
                                {this.state.currentAccountDetails.createDate}
                              </td>
                            </tr>
                            <tr>
                              <td width="25%" style={{ fontWeight: "bold" }}>
                              ...
                              <td align="right">
                                {this.state.currentAccountDetails.currency}
                              </td>
                            </tr>
                            <tr>
                              <td width="25%" style={{ fontWeight: "bold" }}>
                              ...
                              <td align="right">
                                {this.state.currentAccountDetails.owner}
                              </td>
                            </tr>
                      ...
                      <table style={{ width: "100%" }}>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td align="right">
                              {this.state.bankCustomerData.customerId}
                            </td>
                          </tr>
                          <tr>
                            <td width="25%" style={{ fontWeight: "bold" }}>
                            ...
                            <td align="right">
                              {this.state.bankCustomerData.name}
                            </td>
                          </tr>
                          <tr>
                            <td width="25%" style={{ fontWeight: "bold" }}>
                          ...
                          <tr>
                            ...
                            <td align="right">
                              {this.state.bankCustomerData.address}
                            </td>
                          </tr>
                          <tr>
                            <td width="25%" style={{ fontWeight: "bold" }}>
                            ...
                            <td align="right">
                              {this.state.bankCustomerData.idCard}
                            </td>
                          </tr>
                          <tr>
                            <td width="25%" style={{ fontWeight: "bold" }}>
                            ...
                            <td align="right">
                              {this.state.bankCustomerData.expIdDate}
                            </td>
                          </tr>
                          <tr>
                            <td width="25%" style={{ fontWeight: "bold" }}>
                            ...
                            <td align="right">
                              {this.state.bankCustomerData.manager}
                            </td>
                          </tr>
                          <tr>
                            <td width="25%" style={{ fontWeight: "bold" }}>
                            ...
                            <td align="right">
                              {this.state.bankCustomerData.email}
                            </td>
                          </tr>
                          <br />
                          <br />
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            if (
                              ...
                              this.state.bankCustomerData.phoneNumber.length > 5
                            ) {
                              let payload = {
                                phoneNumber:
                                  this.state.bankCustomerData.phoneNumber,
...
const mapStateToProps = ({ agentReducer }) => {
  return {
    bankAccountDetailsFetchSuccessful:
      agentReducer.bankAccountDetailsFetchSuccessful,
...
const mapDispatchToProps = (dispatch) => {
  return {
    doesBankAccountExist: (bankAccountNumber) =>
      dispatch(doesBankAccountExist(bankAccountNumber)),
    sendOtpToCustomer: (token, payload) =>
      dispatch(sendOtpToCustomer(token, payload)),
    fetchAgentBankAccounts: (token, bankCustomerID) =>
      dispatch(fetchAgentBankAccounts(token, bankCustomerID)),
    verifyBankCustomerOTP: (payload) =>
      dispatch(verifyBankCustomerOTP(payload)),
  };
};
