          ...
          >
            <div className="containerBiaN_f_col width30percent textAlignRight">
              <label>
                ...
                <span style={{ color: "darkgray", fontSize: "15px" }}>
                  {"(with Country Code)"}
                </span>
        ...
        <div className="containerBiaN_form" style={{ width: "100%" }}>
          ...
          >
            ...
            >
              ...
              <div
                className="containerBiaN_f_col width80percent"
            ...
            >
              ...
              <div className="containerBiaN_f_col width70percent">
                ...
                <div style={{ display: "flex" }}>
                  ...
                  <p style={{ fontWeight: "bold" }}>XXXXXXXXXX</p>
                </div>
                <div style={{ display: "flex" }}>
                  <p style={{ marginRight: "16px", color: "gray" }}>
                    Phone Number
                  </p>
                  <p style={{ fontWeight: "bold" }}>{"(+XXX) XXX XXXXX"}</p>
                </div>
                <div style={{ display: "flex" }}>
                  <p style={{ marginRight: "16px", color: "gray" }}>Email</p>
                  <p style={{ fontWeight: "bold" }}>XXXXXX@XXXX.XXX</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div
            style={{ borderWidth: 1, marginLeft: "20%", marginRight: "20%" }}
          >
            <div
              className="containerBiaN_f_row"
              style={{ justifyContent: "left" }}
            ...
            >
              ...
              <div className="containerBiaN_f_col width70percent">
                ...
                <div style={{ display: "flex" }}>
                  ...
                  <p style={{ fontWeight: "bold" }}>{"XX2442XX4325XX"}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="containerBiaN_f_row">
            ...
            <div className="containerBiaN_f_col width70percent">
              ...
              <div style={{ display: "flex" }}>
                ...
                <p style={{ fontWeight: "bold" }}>XXXXXXXXXXXXXXXXXX</p>
              </div>
              <div style={{ display: "flex" }}>
                <p style={{ marginRight: "16px", color: "gray" }}>Amount</p>
              ...
              <div className="sectionInn">
                <div className="chartCard_w">
                  ...
                  <div className="chartCardMiddle" style={{ padding: "24px" }}>
                    <>
                      {step === 0 && verificationForm()}
                      {step === 1 && transactionSummary()}
                      {step === 2 && customerOTP()}
