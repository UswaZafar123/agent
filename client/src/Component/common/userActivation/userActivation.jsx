            ...
            <div className="loginInner">
              <div className="loginInform">
                {!this.state.shwVerification && (
                  <div className="row">
                    <h1 className="sub-title text-bold">User Activation</h1>

                    <div className="row dflex-center">
                      <img
                        src={IMAGES.userActivation}
                        style={{
                          width: 184,
                          marginTop: "5%",
                          marginBottom: "5%",
                    ...
                    <p>
                      Link to Virtual/ Master/Super Agent to activate your
                      account,after your account is activated you will have the
                      access to your account and you will be ready to view and
                      manage your account
                    </p>

                    <div
                      className="row dflex-center"
                      style={{ marginTop: "5%" }}
                    >
                      <button
                        className="btn btn-default"
                        onClick={() => {
                          this.setState({ shwVerification: true });
                        }}
                      >
                        Link FB Account
                      </button>
                ...
                {this.state.shwVerification && !this.state.stp2 && (
                  <div className="row">
                    ...
                    <p style={{ fontSize: "36px" }}>
                      Please enter your ID code of Virtual/ Master/super agent
                    </p>
                ...
                {this.state.stp4 && (
                  <div className="row">
                    ...
                    >
                      <img src={IMAGES.Close} style={{ width: 20 }} />
                    </span>

                    <h1
                      className="sub-title text-bold"
                      style={{ marginTop: "5%" }}
                    >
                    ...
                    <p style={{ fontSize: "34px", lineHeight: "46px" }}>
                      Now you can start to carry out transactions up to the UV
                      purchased
                    </p>
