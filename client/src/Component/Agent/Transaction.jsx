...
class Transaction extends Component {
      ...
      columnDefs: [
        { headerName: "Reference Number", field: "transactionReference" },
        {
          ...
          cellRendererFramework: (params) => {
            ...
            return <div>{params.value.split("T")[0]}</div>;
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            // console.log(params, "PARAMS");
            return <div>{params.value.split("T")[1].split(".")[0]}</div>;
          },
        },
  ...
  onGridReady = (params) => {
    ...
    document.getElementById("totalPageSize").innerHTML = this.state.rowData
    ...
    if (changedV <= this.state.rowData ? this.state.rowData.length : 0) {
      ...
      document.getElementById("afterTo").innerHTML = this.state.rowData
        ? this.state.rowData.length
        : 0;
    }
  ...
  componentDidMount() {
    ...
    this.props.getAgentWalletHistory(
      start,
      end,
      0,
      parseInt(this.state.numberOfEntriesToShow)
    );
      ...
      if (nextprops.language == "fr") {
        this.setState({
          columnDefs: [
            ...
            {
              headerName: "Temps de transaction",
              field: "createdDate",
              cellRendererFramework: (params) => {
                // console.log(params, "PARAMS");
                return <div>{params.value.split("T")[1].split(".")[0]}</div>;
                  ...
                  <div className="chartCard_w">
                    ...
                    >
                      ...
                      <div className="fetchsection">
                        <button className="dcbtn" onClick={this.filterData}>
                          <FormattedMessage id="agent.Fetch" />
                        </button>
                      </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    getAgentWalletHistory: (fromDate, toDate, page, size) =>
      dispatch(getAgentWalletHistory(fromDate, toDate, page, size)),
  };
};
