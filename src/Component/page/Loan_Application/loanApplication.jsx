                                ...
                                <div className="chartCard_w">
                                    ...
                                    <div className=" chartCardMiddle" style={{ padding: "24px" }}>
                                        ...
                                        >
                                           <Grid container spacing={3}>
                                            ...
                                            <Grid item xs={12} sm={6}>
                                                ...
                                                <div   className="inputCol" >
                                                    <Input type="text" placeholder="dd-mm-yyyy" name="lastName">
                                                    </Input>
                                                </div>
                                            </Grid>
                                            <Grid item xs={12} sm={6}>
                                            ...
                                            <Grid item xs={12} sm={6}>
                                                ...
                                                <div   style={{width:950}} >
                                                    <Input type="text" placeholder="Full Address"name="adress" >
                                                    </Input>
                                                </div>
                                            </Grid>
                                            <Grid item xs={12} sm={6}>
                                            ...
                                            <Grid item xs={12} sm={6}>
                                                ...
                                                <div   className="inputCol" >
                                                    <Input type="text" placeholder="Postal Poste"name="Postal Poste">
                                                    </Input>
                                                </div>
                                            </Grid>
                                            <Grid item xs={12} sm={6}>
                                                ...
                                                <div   className="inputCol" >
                                                    <Input type="text" placeholder="Amount of credit"name="Amount of credit" >
                                                    </Input>
                                                </div>
                                            </Grid>
                                            <Grid item xs={12} sm={6}>
                                                ...
                                                <div   className="inputCol" >
                                                    <Input type="text" placeholder="Duration of Loan"name="Duration of Loan">
                                                    </Input>
                                                </div>
                                            </Grid>
                                            ...
                                            <Grid item xs={12} sm={6}>
                                                ...
                                                <div   className="inputCol" >
                                                    <Input type="text" placeholder="Purpose of Loan"name="Purpose " >
                                                    </Input>
                                                </div>
                                            </Grid>
                                     ...
                                     <Modal  
                                               ...
                                               style={{width:600,  paddingTop: 200 , borderRadius:30 }}> 
                                            <ModalHeader >
                                            <div  style={{justifyContent:'center', alignContent:'center', alignItems:'center'}} >  
                                                ...
                                                <div > 
                                                    <Label style={{fontSize:30,fontWeight:'bold' ,color:'#DA4139',
                                                       marginTop:20,marginLeft:150, }}>
                                                           Submitted
                                                   </Label>
                                                        <Label className="formColLabel1" style={{marginTop:20, marginLeft:15, fontSize:23}}>
                                                             Your Application for Loan is  submitted</Label>
                                                </div >
                                                </div > 
                                            </ModalHeader>
