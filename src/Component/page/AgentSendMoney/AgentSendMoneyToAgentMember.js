...
const AgentSendMoneyToAgentMember = () => {
    ...
    //     if (feeData)
    //         console.log(feeData.transactionFee, "FEE");
    ...
    }, [step, feeData, agentOtpSuccess, agentSendMoneySuccess]);
    ...
    const getFeeDetail = () => {
        ...
        var requestObj = {
            paymentMethodId:
                feeConstants.constants.AGENT_TO_AGENT_MEMBER,
            subscriptionPlanId: subscriptionId,
            currencyCode: "XAF",
            transactionAmount: amount,
        };
        console.log(requestObj, "FEE CALCULATION");
            ...
            <>
                <div>
                    <div className="containerBiaN_f_col" style={{ padding: "0px" }}>
                        <label>
                            <FormattedMessage id="agent.AgentMemberID" /><span style={{ fontSize: "13px" }}><FormattedMessage id="agent.(withoutcountrycode)" /></span>{" "}
                    ...
                    <div className="containerBiaN_f_col" style={{ padding: "0px" }}>
                        <div className="categorySelect">
                            <Select
                                ...
                                id={'page-size'}
                            >
                                <Option value="DEFAULT" disabled={true}><FormattedMessage id="agent.SelectanAgentMember" /></Option>
                                {
                ...
                <div className="containerBiaN_form">
                    ...
                    <div className="containerBiaN_f_row">
                        <div className="containerBiaN_f_col">
                            ...
                            <div style={{ display: "flex" }}>
                                <p style={{ marginRight: "16px", color: "gray" }}>Sending Amount</p>
                                <p style={{ fontWeight: "bold" }}>{`${amount} XAF`}</p>
                            </div>
                            <div style={{ display: "flex" }}>
                                <p style={{ marginRight: "16px", color: "gray" }}>Calculated Fee</p>
                                <p style={{ fontWeight: "bold" }}>{`${feeData.transactionFee} XAF`}</p>
                            </div>
                            <div style={{ display: "flex" }}>
                                <p style={{ marginRight: "16px", color: "gray" }}>Total Amount Debited</p>
                                <p style={{ fontWeight: "bold" }}>{parseFloat(feeData.transactionFee) + parseFloat(amount) + " XAF"}</p>
                            </div>
                            <div style={{ display: "flex" }}>
                            ...
                            <div className="chartCard_w">
                                <div className="chartCardTop">
                                    <div className="kyccustomformheading">
                                        ...
                                        >
                                            <FormattedMessage id="agent.SendMoneytoAgentMember" />
                                        </h1>
                                    </div>
                                </div>
...
export default AgentSendMoneyToAgentMember;
