...
const AgentSendMoneyToAgentMember = () => {
  ...
  const getFeeDetail = () => {
    ...
    var requestObj = {
      paymentMethodId: feeConstants.constants.AGENT_TO_AGENT_MEMBER,
        ...
        <>
          <div>
            <div className="containerBiaN_f_col" style={{ padding: "0px" }}>
              <label>
                <FormattedMessage id="agent.AgentMemberID" />
              ...
              <div className="categorySelect">
                ...
                >
                  <Option value="DEFAULT" disabled={true}>
                    <FormattedMessage id="agent.SelectanAgentMember" />
                  </Option>
                  {getAllAgentMemberList !== null &&
                    (getAllAgentMemberList.length > 0) &
                      (getAllAgentMemberList !== undefined) &&
                    getAllAgentMemberList.map((agentMember) => {
                      if (agentMember.agentType === "AGENT_MEMBER")
                        return (
                          <Option value={agentMember.phoneNo}>
                            {agentMember.firstName +
                              " " +
                              agentMember.lastName +
                              " : " +
                              agentMember.phoneNo}
                          </Option>
                        );
            ...
            <div className="containerBiaN_f_col">
              ...
              <div style={{ display: "flex" }}>
                ...
                <p style={{ fontWeight: "bold" }}>
                  {parseFloat(feeData.transactionFee) +
                    parseFloat(amount) +
                    " XAF"}
                </p>
              </div>
