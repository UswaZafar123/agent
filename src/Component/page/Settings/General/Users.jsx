...
class Users extends Component {
          ...
          cellRendererFramework: (params) => (
            <div className="ac-view">
              ...
              <span
                ...
                style={{ marginLeft: "5%" }}
                onClick={() => this.editAgentUser(params.data)}
              ></span>
              <span
                className="icon-Group-357"
                style={{ marginLeft: "5%" }}
                onClick={() => this.handleDeleteModal(params.data.AgentUserID)}
              ></span>
            </div>
          ),
          cellStyle: (params) => {
  ...
  componentWillReceiveProps = async (nextprops) => {
    ...
    if (
      nextprops.getAgentDataStatus &&
      nextprops.getAgentData !== null &&
      nextprops.getAgentData !== undefined &&
      nextprops.getAgentData._embedded !== null &&
      nextprops.getAgentData._embedded !== undefined
    ) {
      this.setState({
            ...
            cellRendererFramework: (params) => (
              <div className="ac-view">
                ...
                <span
                  ...
                  style={{ marginLeft: "5%" }}
                  onClick={() =>
                    this.handleDeleteModal(params.data.AgentUserID)
                  }
                ></span>
              </div>
            ),
                        ...
                        >
                          <div className="containerBiaN_form">
                            ...
                            <div className="containerBiaN_f_row">
                              <div className="containerBiaN_f_col width30percent textAlignRight">
                                <label>
                                  <FormattedMessage id="agent.Username" />
                                </label>
                              </div>
                              <div className="containerBiaN_f_col width70percent">
                                ...
                                <div className="categorySelect">
                                  ...
                                  >
                                    <Option value="DEFAULT" disabled={true}>
                                      <FormattedMessage id="agent.SelectaRole" />
                                    </Option>
                                    {this.state.rolesData.map((data) => {
                                      return (
                                        <>
                                          <Option value={data.userRoleId}>
                                            {data.name}
                                          </Option>
                                        </>
                                      );
                        ...
                        >
                          <div className="containerBiaN_form">
                            ...
                            <div className="containerBiaN_f_row">
                              <div className="containerBiaN_f_col width30percent textAlignRight">
                                <label>
                                  Role <span className="mantdat">*</span>
                                </label>
                              </div>
                              <div className="containerBiaN_f_col width70percent">
                                <div className="categorySelect">
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getAllAgentUsers: () => dispatch(getAllAgentUsers()),
