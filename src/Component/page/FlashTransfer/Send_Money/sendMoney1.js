                                        ...
                                        <div className="ag-theme-alpine agGridCustomize"
                                            ...
                                            <div className="eltAlign" >
                                                ...
                                                <div className="inputFlash"  >
                                                    ...
                                                    <Input value={this.state.phone} onChange={event => this.setState({ phone: event.target.value.replace(/\D/, '') })} placeholder="Enter Mobile Number" />
                                                </div>
                                            </div>
                                            ...
                                            <div className="eltAlign" >
                                                ...
                                                <div className="inputFlash"   >
                                                    ...
                                                    <Input value={this.state.amount} onChange={event => this.setState({ amount: event.target.value.replace(/\D/, '') })} placeholder="Enter Amount" />
                                                </div>
                                            </div>
