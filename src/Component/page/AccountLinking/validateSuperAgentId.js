...
import { fetchAgentProfile, sendOtpToAgent, validateSuperAgent } from "../../../services/agent/action.js";
...
const ValidateBankCustomerId = () => {
    ...
    const agentOtpSendLoading = useSelector(state => state.agentReducer.agentOtpSend.loading);
    const agentOtpSendSuccess = useSelector(state => state.agentReducer.agentOtpSend.success);
    const validateSuperAgentLoading = useSelector(state => state.agentReducer.validateSuperAgent.loading);
    const validateSuperAgentSuccess = useSelector(state => state.agentReducer.validateSuperAgent.success);
    ...
    const stepThreeValidated = () => {
        return !(validator.isEmpty(otp) || otp.length !== 6 || validateSuperAgentLoading);
    };
        ...
        <div className="containerBiaN_form">
            <div className="containerBiaN_f_row">
                ...
                <div className="containerBiaN_f_col width70percent">
                    <input placeholder="Enter your customer Id" type="number" value={bankCustomerId} onChange={(e) => setBankCustomerId(e.target.value)}/>
                </div>
            </div>
        </div>
      </>
                  ...
                  <div className="sectionInn">
                      <div className="chartCard_w">
                          ...
                          <div className="chartCardMiddle" style={{ padding: "24px" }}>
                              {(() => {
                                switch(step) {
                                  case 1: return bankCustomerIdForm();
                                  case 2: return agentOTPType();
                                  case 3: return agentOTP();
                                  case 4: return successPage();
                          ...
                          <div style={{width: "100%", float: "left"}}>
                              <div className="confirm_p_w mTB00 button-container rspacing">
                                {step !== 1 & step !== 4 ? <button className="blackbtn aryousureBTN confirmBtnR" onClick={() => prevStep()}>Back</button> : ''}
                                  <button 
