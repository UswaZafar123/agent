            ...
            columnDefs: [
                ...
                { headerName: " Transaction status", field: "Currency" },
                {
                    ...
                    cellRendererFramework: (params) => <div className="ac-view">
                        <button className="edit" onClick={this.editNewCashOperations}>Edit</button>
                        <button className="delete ml4px">Delete</button>
                        <button className="clone ml4px" onClick={this.editNewCashOperations}>Clone</button>
                    </div>,
    ...
    <>
                            ...
                            <div className="sectionInn">
                                <div className="chartCard_w">
                                    ...
                                    <div className="chartCardMiddle" style={{ padding: "24px" }}>
                                        ...
                                        {!this.state.transactionInformations && !this.state.transactionsummury &&
                                        <>
                                       ...
                                       <div style={{width: "100%", float: "left"}}>
                                           <div className="confirm_p_w mTB00 button-container rspacing">
                                               ...
                                               <button className="aryousureBTN confirmBtnR" onClick={this.SubmitOperation}>Submit</button>
                                            </div>
                                        </div>
                                        </>
                                        }
        ...
        {this.state.transactionInformations && 
                                       ...
                                       <div style={{width: "100%", float: "left"}}>
                                           <div className="confirm_p_w mTB00 button-container rspacing">
                                               {/* <button className="blackbtn aryousureBTN confirmBtnR" onClick={this.back5}>Cancel</button> */}
                                               <button className="aryousureBTN confirmBtnR" onClick={this.pay}>Pay</button>
                                            </div>
                                        </div>
                                        </>
                                        }
