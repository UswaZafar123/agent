...
const BankAccountBalance = () => {
  ...
  useEffect(() => {
    ...
    if (step === 4 && customerBalanceInquirySuccess) {
      setStep(5);
    }
  }, [
    step,
  ...
  const sendBalanceInquiry = () => {
    ...
    dispatch(bankBalanceInquiryAction(requestObj));
  };
            ...
            <div className="containerBiaN_f_col width70percent">
              <div style={{ display: "flex" }}>
                <p style={{ marginRight: "16px", color: "gray" }}>
                  Balance Detail has been send to this Account Number:{" "}
