                                    ...
                                    <div className="kyccustomform chartCardMiddle" style={{ padding: "24px" }}>
                                        ...
                                        <div className="sendkycdetailsbox kycDetailsBox">
                                            ...
                                            <div className="kycformBox forBootSHandled">
                                                    ...
                                                    <Row>
                                                        <Col style={{display:"flex", alignItems:"center", justifyContent:"flex-start", marginLeft:"1%"}}><label className="formColLabel">Sender</label></Col>
                                                        <Col md={8}>
                                            ...
                                            <div class="custom-d-flex confirm_p_w mTB00 button-container">
                                                ...
                                                <button class="aryousureBTN confirmBtnR" onClick={this.sendMoney}>Request Money</button>
                                            </div>
                                        </div>
