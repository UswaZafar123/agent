...
class Operations extends Component {
        ...
        { headerName: "Asset Status ", field: "assetStatus" },
        {
          ...
          cellRendererFramework: (params) => (
            <div className="ac-view">
              ...
              &ensp;
              <button
                onClick={() => this.handleDeleteModal(params.data.operationID)}
              >
  ...
  onGridReady = (params) => {
    ...
    document.getElementById("totalPageSize").innerHTML =
      this.state.operationsData.length;
  ...
  async componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.operationDetails && nextProps.operationStatus) {
      console.log(
        nextProps.operationDetails._embedded.operationDtoList,
        "OPER"
      );
          ...
          { headerName: "État de l'actif ", field: "assetStatus" },
          {
            ...
            cellRendererFramework: (params) => (
              <div className="ac-view">
                ...
                <button
                  onClick={() =>
                    this.handleDeleteModal(params.data.operationID)
                  }
                >
                  {<FormattedMessage id="agent.Delete" />}
                </button>
                          ...
                          >
                            ...
                            >
                              <AgGridReact
                                ...
                                rowData={this.state.operationsData.map(
                                  (data) => {
                                    return {
                                      operationID: data.operationId,
                            ...
                            <div className="containerBiaN_form">
                              <div className="containerBiaN_f_row">
                                <div className="containerBiaN_f_col width30percent textAlignRight">
                                  <label>
                                    <FormattedMessage id="agent.OperationName" />
                              ...
                              <div className="containerBiaN_f_row">
                                <div className="containerBiaN_f_col width30percent textAlignRight">
                                  <label>
                                    <FormattedMessage id="agent.Asset" />{" "}
                                    <span className="mantdat">*</span>
                                  </label>
                                </div>
                                <div className="containerBiaN_f_col width70percent">
                            ...
                            <div style={{ width: "100%", float: "left" }}>
                              <div className="confirm_p_w mTB00 button-container rspacing">
                                <button
                                  ...
                                  onClick={this.goToMainOperationsPage}
                                >
                              ...
                              <div className="containerBiaN_f_row">
                                ...
                                <div className="containerBiaN_f_col width70percent">
                                  <div className="categorySelect">
                                    ...
                                    >
                                      <Option value="DEFAULT" disabled={true}>
                                        <FormattedMessage id="agent.SelectanAsset" />
                                      </Option>
                                      {this.state.assetData.map((data) => {
                                        return (
                                          <>
