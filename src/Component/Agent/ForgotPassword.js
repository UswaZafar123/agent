                                ...
                                >
                                    <div style={{ textAlign: "center" }}>
                                        <h2 style={{ fontSize: '15px' }}>
                                            Please enter the verification code you received on <br /> {this.state.mobileNumber}
                                        </h2>
                            ...
                            <div className="agent-cat-box">
                                <div className="display-linebreak">
                                    ...
                                    <button
                                        ...
                                        style={{
                                            backgroundColor: this.state.isPasswordsMatching ? "#DA4139" : "darkgrey",
                                            borderColor: this.state.isPasswordsMatching ? "#DA4139" : "darkgrey",
                                        }}
