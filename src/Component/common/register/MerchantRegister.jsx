                  ...
                  <div className="row">
                    ...
                    <div className="col-md-12 float-left">
                      ...
                      <div className="row">
                        ...
                        >
                          By Clicking on Next, you conform that you're entitled
                          to uss this mobile phone number. You also accept to
                          receive automated text messages to confirm the phone
                          number and to take on any related charges that may
                          apply.
                        </p>
                      </div>
                      ...
                      <div className="row">
                        ...
                        >
                          <button
                            ...
                            onClick={this.sendVerificationOTP}
                          >
                            Next
                          </button>
                        </div>
              ...
              {this.state.verifyOtp && (
                <div className="row">
                  ...
                  <div className="col-md-12 float-left">
                    ...
                    <p style={{ color: "red" }}>
                      Security question will help to recover your account when
                    ...
                    >
                      ...
                      <div style={{ position: "relative", display: "flex" }}>
                        <input
                          type="text"
                          name="company_bussiness_document"
