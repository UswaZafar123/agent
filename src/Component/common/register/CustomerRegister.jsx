...
class CustomerRegister extends Component {
  ...
  handleSubmit = (e) => {
    ...
    formData.append(
      ...
      Moment(this.state.expireDate).format("YYYY-MM-DD")
    );
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.customerregister) {
      this.props.history.push({
        pathname: "/customer/register/verify/account",
        state: { phone: this.state.mobile },
      });
    }
  }
            ...
            <div className="loginInner" style={{ width: "901px" }}>
              <form onSubmit={this.handleSubmit}>
                {!this.state.showMobileSubscription && (
                  <div className="row">
                    <span className="absolute" style={{ cursor: "pointer" }}>
                    ...
                    >
                      <button
                        ...
                        onClick={() => {
                          this.setState({ showMobileSubscription: true });
                        }}
                      >
                        Subscription
                      </button>
                  ...
                  !this.state.customeRegAccountType && (
                    <div className="row">
                      <span
                        ...
                        onClick={() => {
                          this.setState({ showMobileSubscription: false });
                          this.setState({ customeRegAccountType: false });
                        }}
                      >
                        <img src={IMAGES.Back} style={{ width: 15 }} />
                      </span>
                        ...
                        <ul className="account-type-options-2">
                          ...
                          >
                            <input
                              ...
                              id="non_bank_account"
                              name="account"
                              value="NON_EXISTING_BANK_CUSTOMER"
                              className="mr-3"
                              onChange={this.selectAccountType}
                            />
                            <label
                              htmlFor="non_bank_account"
                              style={{
                                width: "55%",
                                textAlign: "center",
                                color: "#343A40",
                      ...
                      >
                        <button
                          className="btn btn-default text-white"
                          onClick={() => {
                            this.setState({ customeRegAccountType: true });
                          }}
                        >
                          Next
                        </button>
                      ...
                      <div className="row">
                        ...
                        >
                          <label className="privacy_policy">
                            ...
                            <a>privacy policy of BIA DigiBank banking</a>
                          </label>
                        </div>
                      </div>
                      <div className="row">
...
const mapDispatchToProps = (dispatch) => ({
  RegisterService: (payLoad) => dispatch(RegisterService(payLoad)),
});
