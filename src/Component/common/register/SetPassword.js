...

                {
                    !this.state.showMobileSubscription && (
                        ...
                        <div className="col-md-12 float-left" style={{display:"flex", justifyContent:"space-between"}}>
                            <button className="btn btn-default text-white" onClick={this.setPassword}>Set Password</button>
                            <button className="btn btn-default text-white" onClick={ () => {this.setState({showMobileVerification:true})}}>Cancel</button>
                        </div>
