...
class nonAfbCustomer extends Component {
                                    ...
                                    <div className=" chartCardMiddle" style={{ padding: "24px" }}>
                                        <Grid container spacing={3}>
                                            ...
                                            <Grid item xs={12} sm={6}>
                                                ...
                                                <div   className="inputFlash" >
                                                    <Input type="text" placeholder="Date of Birth"name="dateOfBirth" value={this.state.dateOfBirth}>
                                                    </Input>
                                                </div>
                                            </Grid>
                                            <Grid item xs={12} sm={6}>
                                            ...
                                            <Grid item xs={12} sm={6}>
                                                ...
                                                <div   className="inputFlash" >
                                                    <Input type="text" placeholder="UIN"name="uin" value={this.state.uin}>
                                                    </Input>
                                                </div>
                                            </Grid>
                                            <Grid item xs={12} sm={6}>
                                                ...
                                                <div   className="inputFlash" >
                                                    <Input type="text" placeholder="expiry Date"name="expiryDate" value={this.state.expiryDate}>
                                                    </Input>
                                                </div>
                                            </Grid>
                                            <Grid item xs={12} sm={6}>
                                            ...
                                            <Grid item xs={12} sm={6}>
                                                ...
                                                <button className="btn_view_proof_non_afb_customer"> View Proof</button>
                                            </Grid>
                                            <Grid item xs={12} sm={6}>
...
export default connect(mapStateToProps,mapDispatchToProps) (nonAfbCustomer);